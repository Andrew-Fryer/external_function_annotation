...
I tried to use a non-terminal from rust.grm, but it doesn't parse THIR properly and it seemed difficult to modify it in the correct places...
...
Note that all_calls.txt has duplicate callees.

I think I'll just deal with this in Python.
